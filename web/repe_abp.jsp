                    ...
                    <table style="width: 95%;" align='center'>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="hipo" type="text" style="text-align: center" readonly="true" class="form-control" value="${row.Score_Hipotecario}">                                
                                </td>
                            </tr>
                            <tr>
                                <td style="vertical-align:middle;font-size: 14px">
                                ...
                                <td>
                                    <input type="text" id="buro" style="text-align: center" readonly="true" class="form-control" value="${row.Score_Hipotecario}">                                
                                </td>
                            </tr>                            
                            <tr>
                                <td style="vertical-align:middle;font-size: 14px">
