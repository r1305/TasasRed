                ...
                <center>
                    <table width="101%">
                        <tr style="background-color: #00A94E;height: 50px">
                            <th style="background-color:#009042 ;text-align: center;vertical-align:middle;"><a href="formulario.jsp" style="color: #FFFFFF"><b>Enviadas (<c:forEach var="b" items="${n.rows}">${b.numero}</c:forEach>)</b></a></th>
                            ...
                            <table class="table" border="1" id="t1" name="t1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style=";font-size: 16px;text-align: center;vertical-align:middle;" align="center" width="8%"><b>Tasa ADQ</b></th>
                                        ...
                                        <th style=";font-size: 16px;text-align: center;vertical-align:middle;" align="center" ><b>Adjunto</b></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
