                ...
                <center>
                    <table width="101%">
                        <tr style="background-color: #00A94E;height: 50px">
                            ...
                            <th style="background-color:#009042 ;text-align: center;vertical-align:middle;"><a  href="formulario3.jsp" style="color: #FFFFFF"><b>Contra Ofertas (<c:forEach var="b" items="${r.rows}">${b.numero}</c:forEach>)</b></a></th>
                            ...
                            <table class="table" border="1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style=";font-size: 16px;text-align: center;vertical-align:middle;" align="center" width="8%"><b>Tasa Mínima</b></th>
