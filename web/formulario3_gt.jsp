                ...
                <center>
                    <table width="101%" border="1">
                        <tr style="background-color: #00A94E;height: 50px">
                            <th style="text-align: center;vertical-align:middle;width: 20%"><a onclick="actualizar()" href="formulario_gt.jsp" style="color: #FFFFFF"><b>Enviadas (<c:forEach var="b" items="${n.rows}">${b.numero}</c:forEach>)</b></a></th>
                            <th style="text-align: center;vertical-align:middle;width: 20%"><a onclick="actualizar()" href="formulario2_gt.jsp" style="color: #FFFFFF"><b>Aceptadas (<c:forEach var="b" items="${a.rows}">${b.numero}</c:forEach>)</b></a></th>
                            <th style="background-color:#009042 ;text-align: center;vertical-align:middle;width: 20%"><a onclick="actualizar()" href="formulario3_gt.jsp" style="color: #FFFFFF"><b>Contra Ofertas (<c:forEach var="b" items="${r.rows}">${b.numero}</c:forEach>)</b></a></th>
                            <th style="text-align: center;vertical-align:middle;width: 20%"><a onclick="actualizar()" href="formulario4_gt.jsp" style="color: #FFFFFF"><b>Vencidas (<c:forEach var="b" items="${v.rows}">${b.numero}</c:forEach>)</b></a></th>
                                <th style="text-align: center;vertical-align:middle;width: 20%"><a onclick="actualizar()" href="formulario5_gt.jsp" style="color: #FFFFFF"><b>Solicitud</b></a></th>                               
                            </tr>
                        </table>
                    </center>
                </div>
                            ...
                            <table class="table" border="1">
                                <thead>
                                    <tr>
                                        ...
                                        <th style=";font-size: 14px;text-align: center;vertical-align:middle;color: #00A94E" align="center" width="8%"><b>Tasa Mínima</b></th>
